    ...
    return (
        <BoxMui className="about-me-section">
            ...
            <BoxMui className="about-me-content">
                <Typ variant="h4" className="sub-text" sx={{fontFamily: 'IBM Plex Mono, monospace', fontWeight: 800, fontSize:'28px', transform: 'scaleY(1.2)'}}>
                ...
                <Typ variant="body1" className="follow-text" sx={{color:'#a2a0a1', fontFamily:'Arial, Helvetica, sans-serif'}}>
                    ¡Contáctame para comenzar a trabajar juntos en tu proyecto web!
                </Typ>
                <BoxMui className="social-icons">
                    <IconButton href="https://behance.net" target="_blank">
